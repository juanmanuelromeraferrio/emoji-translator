...
describe('Footer', () => {
    test('renders the footer with correct content', () => {
        ...
        const githubLink = screen.getByRole('link', { name: /emoji translator on github/i });
        expect(githubLink).toBeInTheDocument();
        expect(githubLink).toHaveAttribute('href', 'https://github.com/juanmanuelromeraferrio/emoji-translator');
    });
});
